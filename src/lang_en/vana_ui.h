...
const wchar_t szTitle[]=		L"Virtual ear music analyzer";
...
const wchar_t szErr_FileFormat[]=	L"This is not a standard wav file!";
...
const wchar_t szMenu_Stop[]=		L"Stop";
const wchar_t szMenu_Help[]=		L"Help";

const wchar_t szDialog[]=		L"Set parameter";
const wchar_t szLbl_File[]=		L"File";
const wchar_t szLbl_SampleRate[]=	L"Sample rate";
const wchar_t szLbl_Length[]=		L"Length";
...
const wchar_t szBtn_Analyze[]=		L"Analyze";
const wchar_t szErr_Tuning[]=		L"Tuning: Invalid input.";
...
const wchar_t szErr_Amplify[]=		L"Amplify: Invalid input.";
