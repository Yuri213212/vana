...
const wchar_t szTitle[]=		L"虚拟耳朵音乐分析仪";
...
const wchar_t szErr_FileFormat[]=	L"这不是标准wav文件！";
...
const wchar_t szDialog[]=		L"设置参数";
const wchar_t szLbl_File[]=		L"文件";
const wchar_t szLbl_SampleRate[]=	L"采样率";
const wchar_t szLbl_Length[]=		L"长度";
...
const wchar_t szErr_Tuning[]=		L"调音：无效的输入。";
...
const wchar_t szErr_Amplify[]=		L"增益：无效的输入。";
